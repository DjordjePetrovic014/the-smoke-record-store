...
- **Note on Code Structure:** -this is a work-in-progress project. Some parts of the codebase (e.g., data handling, component separation) are not yet fully modular or optimized. JSON structures and reusable functions will be separated and cleaned up in future iterations. Current focus has been on core logic and UI/UX behavior.
